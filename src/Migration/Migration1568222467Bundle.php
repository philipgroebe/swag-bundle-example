...
class Migration1568222467Bundle extends MigrationStep {
    ...
    public function update(Connection $connection): void 
    {
        ...
        $connection->executeQuery('
            CREATE TABLE IF NOT EXISTS `swag_bundle_product` (
                ...
                CONSTRAINT `fk.bundle_product.bundle_id` 
                    FOREIGN KEY (`bundle_id`)
                    REFERENCES `swag_bundle` (`id`) 
                        ON DELETE CASCADE 
                        ON UPDATE CASCADE,
                CONSTRAINT `fk.bundle_product.product_id__product_version_id` 
